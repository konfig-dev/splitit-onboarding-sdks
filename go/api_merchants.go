...
func (r MerchantsApiCreateDeveloperRequest) CreateDeveloperRequest(createDeveloperRequest CreateDeveloperRequest) MerchantsApiCreateDeveloperRequest {
	r.createDeveloperRequest = &createDeveloperRequest
	return r
}

func (r MerchantsApiCreateDeveloperRequest) Execute() (*CreateMerchantResponse, *http.Response, error) {
	return r.ApiService.CreateDeveloperExecute(r)
}
...
*/
func (a *MerchantsApiService) CreateDeveloper() MerchantsApiCreateDeveloperRequest {
	return MerchantsApiCreateDeveloperRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
	}
...
// Execute executes the request
//  @return CreateMerchantResponse
func (a *MerchantsApiService) CreateDeveloperExecute(r MerchantsApiCreateDeveloperRequest) (*CreateMerchantResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MerchantsApiService.CreateDeveloper")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/merchants/create/developer"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createDeveloperRequest == nil {
		return localVarReturnValue, nil, reportError("createDeveloperRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createDeveloperRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
