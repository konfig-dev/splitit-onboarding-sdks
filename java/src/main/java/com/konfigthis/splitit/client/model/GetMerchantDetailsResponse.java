...
public class GetMerchantDetailsResponse {
  ...
  **/
   ...
   * @return the GetMerchantDetailsResponse instance itself
   */
  public GetMerchantDetailsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.publicName, getMerchantDetailsResponse.publicName) &&
        ...
        Objects.equals(this.additionalProperties, getMerchantDetailsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publicName, legalName, phoneNumber, merchantTempId, email, merchantStatus, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetMerchantDetailsResponse>() {
           ...
           public GetMerchantDetailsResponse read(JsonReader in) throws IOException {
             ...
             GetMerchantDetailsResponse instance = thisAdapter.fromJsonTree(jsonObj);
