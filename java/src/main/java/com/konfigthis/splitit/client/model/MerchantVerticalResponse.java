...
public class MerchantVerticalResponse {
  ...
  **/
   ...
   * @return the MerchantVerticalResponse instance itself
   */
  public MerchantVerticalResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.verticalDisplayName, merchantVerticalResponse.verticalDisplayName) &&
        ...
        Objects.equals(this.additionalProperties, merchantVerticalResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(verticalDisplayName, verticalSplititName, subCategories, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MerchantVerticalResponse>() {
           ...
           public MerchantVerticalResponse read(JsonReader in) throws IOException {
             ...
             MerchantVerticalResponse instance = thisAdapter.fromJsonTree(jsonObj);
