...
public class CountryResponse {
  ...
  **/
   ...
   * @return the CountryResponse instance itself
   */
  public CountryResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, countryResponse.id) &&
        ...
        Objects.equals(this.additionalProperties, countryResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, isoA2, isoA3, isoNumber, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CountryResponse>() {
           ...
           public CountryResponse read(JsonReader in) throws IOException {
             ...
             CountryResponse instance = thisAdapter.fromJsonTree(jsonObj);
