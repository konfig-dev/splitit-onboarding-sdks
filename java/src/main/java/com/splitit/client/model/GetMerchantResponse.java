...
public class GetMerchantResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, legalName, phone, country, annualSales, status, merchantTempId);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetMerchantResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMerchantResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
