...
import com.splitit.client.auth.HttpBasicAuth;
import com.splitit.client.auth.HttpBearerAuth;
import com.splitit.client.auth.ApiKeyAuth;
import com.splitit.client.auth.OAuth;
import com.splitit.client.auth.RetryingOAuth;
import com.splitit.client.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://onboarding-v2.sandbox.splitit.com";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://auth.sandbox.splitit.com/connect/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://onboarding-v2.sandbox.splitit.com
     ...
     * @return a {@link com.splitit.client.ApiClient} object
     */
     ...
     * @throws com.splitit.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.splitit.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.splitit.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.splitit.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.splitit.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.splitit.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.splitit.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.splitit.client.ApiException If fail to serialize the request body object into a string
     */
